...
def cargar_modelos_ml():
    ...
    """
    modelos = {}
    carpeta = "models"   # <--- CORREGIDO: antes era "models/models"
    ...
    for archivo in archivos:
        ...
        try:
            ...
            # --- Caso 1: ensemble (diccionario con multiples metricas) ---
...
def calcular_ma(df, col, ventana):
    """Calcula media movil de los ultimos N partidos de una columna."""
...
def construir_features_ml(df_local, df_visit, es_local, jornada, pos_rival):
    ...
    a partir de los DataFrames historicos del equipo.
    """
    col_map = {
...
def combinar_metrica_ml(metricas_metrica, pred_ml, jornada):
    """
    Combina rama metrica y rama ML con pesos segun jornada.
    """
    if pred_ml is None:
...
# =========================================================
# CLASIFICACION DESDE LIBRO HISTORICO
# =========================================================
def obtener_clasificacion_desde_historico(id_libro_historico, nombre_pestana_clasificacion, jornada_buscada):
    try:
        ...
        st.warning(f"Error leyendo clasificacion historica: {e}")
        return pd.DataFrame()
...
def mapear_columnas(df):
    ...
    columnas_buscar = {
        ...
        "CORNERES FAVOR":            ["corneres favor", "corners favor", "cornes favor", "corner favor"],
        "CORNERES CONTRA":           ["corneres contra", "corners contra", "cornes contra", "corner contra"],
...
def cargar_pestana_equipo(ws):
    try:
        ...
        st.warning(f"Error cargando pestana: {e}")
        return pd.DataFrame()
...
try:
    ...
    if st.button("📊 GENERAR ANALISIS"):
        ...
        try:
            ...
            st.success(
                f"Clasificacion Jornada {jornada_clasificacion}: "
